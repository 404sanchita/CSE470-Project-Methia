  ...
  const handleBookingSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `http://localhost:5000/api/restaurants/${selectedRestaurant._id}/book`,
        bookingData
      );
  ...
  const fetchUserBookings = async (email) => {
    ...
    try {
      const response = await axios.get(
        `http://localhost:5000/api/restaurants/bookings/my?email=${encodeURIComponent(email.trim())}`
      );
                    ...
                    <div className="restaurant-info">
                      ...
                      <div style={{ marginTop: "1rem", marginBottom: "1rem" }}>
                        <LikeDislike
                          ...
                          initialLikes={restaurant.likesCount || 0}
                          initialDislikes={restaurant.dislikesCount || 0}
                          initialReaction={restaurant.userReaction || null}
                        />
                      </div>
                      ...
                      <div style={{ marginTop: "1rem", marginBottom: "1rem" }}>
                        ...
                        <CommentSection resourceType="restaurant" resourceId={restaurant._id} />
                      </div>
